...
export const SEED_COMPANIES = [
  ...
  { name: 'Cleveland Clinic',          ats: 'workday', token: 'clevelandclinic',
    url: 'https://jobs.clevelandclinic.org', inactive: true, inactiveReason: 'audit S21: custom domain, not Workday SSR (jobs.clevelandclinic.org)' }, // Custom domain — /wday/cxs/ API unavailable; SSR fallback path
  { name: 'Mass General Brigham',      ats: 'workday', token: 'massgeneralbrigham',
    url: 'https://massgeneralbrigham.wd1.myworkdayjobs.com/en-US/MGB_External', mdApproved: true, inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'Geisinger',                 ats: 'workday', token: 'geisinger',
    url: 'https://geisinger.wd5.myworkdayjobs.com/en-US/MyGeisingerCareers', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'Banner Health',             ats: 'workday', token: 'bannerhealth',
    url: 'https://bannerhealth.wd108.myworkdayjobs.com/Careers' },
  // audit S23: confirmed wd108 (CXS 200 OK); was incorrectly listed as wd5
  ...
  { name: 'Prisma Health',             ats: 'workday', token: 'prismahealth',
    url: 'https://prismahealth.wd5.myworkdayjobs.com/en-US/PrismaHealthCareers', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'Seattle Children\'s',       ats: 'workday', token: 'seattlechildrens',
    ...
    inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'Stanford Health Care',      ats: 'workday', token: 'stanfordhealthcare',
    ...
    inactive: true, inactiveReason: 'audit S23: wd5 CF-blocked (422/500); stanfordmedicine.wd115 confirmed active (6 jobs) — use that entry' },
  ...
  { name: 'ArcBest',                   ats: 'workday', token: 'arcbest',
    url: 'https://arcbest.wd5.myworkdayjobs.com/en-US/Careers', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'Sagility', ats: 'workday', url: 'https://sagility.wd1.myworkdayjobs.com/SagilityHealth', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'CoxHealth', ats: 'workday', url: 'https://coxhealth.wd5.myworkdayjobs.com/CoxHealth_Careers', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'OhioHealth', ats: 'workday', url: 'https://ohiohealth.wd5.myworkdayjobs.com/OhioHealth_External', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
...
export const BATCH_WATCHLIST = [
  ...
  { name: 'Memorial Hermann',          ats: 'workday', token: 'memorialhermann',
    url: 'https://memorialhermann.wd5.myworkdayjobs.com/en-US/Memorial_Hermann_External', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'Humana',                    ats: 'workday', token: 'humana',
    url: 'https://humana.wd5.myworkdayjobs.com/en-US/Humana_External', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  { name: 'Cigna',                     ats: 'workday', token: 'cigna',
    url: 'https://cigna.wd5.myworkdayjobs.com/en-US/Cigna_Careers', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'Centene',                   ats: 'workday', token: 'centene',
    url: 'https://centene.wd5.myworkdayjobs.com/en-US/External', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  { name: 'Magellan Health',           ats: 'workday', token: 'magellanhealth',
    url: 'https://magellanhealth.wd5.myworkdayjobs.com/en-US/External', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
  ...
  { name: 'Manhattan Associates',      ats: 'workday', token: 'manh',
    url: 'https://manh.wd5.myworkdayjobs.com/en-US/MANH_Careers', inactive: true, inactiveReason: 'audit S21: HTTP 404' },
