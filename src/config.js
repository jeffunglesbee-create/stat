...
export const SEED_COMPANIES = [
  ...
  { name: 'VHC Health',                ats: 'workday', token: 'vhchealth',
    url: 'https://vhchealth.wd1.myworkdayjobs.com/en-US/VHCHealth' },
  ...
  { name: 'Concentrix',                ats: 'workday', token: 'concentrix',
    url: 'https://concentrix.wd5.myworkdayjobs.com/en-US/External' },
  { name: 'TTEC',                      ats: 'workday', token: 'ttec',
    url: 'https://ttec.wd5.myworkdayjobs.com/en-US/External' },
  ...
  { name: 'Maximus',                   ats: 'workday', token: 'maximus',
    url: 'https://maximus.wd5.myworkdayjobs.com/en-US/External' },
