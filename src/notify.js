...
export function matchJob(job, customKeywords = null) {
  ...
  const haystack = `${job.title} ${job.company} ${job.description || ''}`.toLowerCase();atcher + Notifier
 */
