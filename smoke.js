...
assert('adapters: mapHiringCafeHit defined', read('adapters.js').includes('function mapHiringCafeHit'));
...
assert('routes/ui: UI_ETAG computed at module load', read('routes/ui.js').includes('const UI_ETAG = (() =>'));
assert('routes/ui: /ui returns 304 on ETag match', read('routes/ui.js').includes('status: 304'));
assert('routes/ui: /ui ETag header set on 200', read('routes/ui.js').includes("'ETag': UI_ETAG"));
